...
!! (sphere case - N temperatures).
  SUBROUTINE source_term_diff_neqNT_1D_SL_sph (r_c, vol_l, vol_c, vol_r, prop_left, prop_cell, prop_right, & 
    ...
    REAL(KIND=8) :: dens, u, v, mu, p, q_intk, rhoi_Vdi, T
  ...
  END SUBROUTINE source_term_diff_neqNT_1D_SL_sph
!------------------------------------------------------------------------------!

...
!! (sphere case - N temperature and one for free electrons Te).
  SUBROUTINE source_term_diff_neqNT_Te_1D_SL_sph(r_c, vol_l, vol_c, vol_r, prop_left, prop_cell, prop_right, & 
    ...
    USE mod_general_data,            ONLY: nb_ns, nb_temp, nb_int_temp, pos_u_cell, pos_v_cell, pos_ei_cell,  & 
                                         ...
                                         & pos_rhov, pos_rhoE, pos_rhoek, rhoi, xi, Ri, ei, diff_driv,        & 
                                         & Ji, lambda_vec, nb_te, pos_em, nb_eq
    ...
    REAL(KIND=8) :: dens, u, v, mu, p, q_intk, rhoi_Vdi, T, Te
  ...
  END SUBROUTINE source_term_diff_neqNT_Te_1D_SL_sph
!------------------------------------------------------------------------------!

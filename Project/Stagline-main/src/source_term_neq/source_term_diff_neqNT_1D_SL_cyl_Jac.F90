...
!! for nonequilibrium flows (cylinder case - N temperatures).
  SUBROUTINE source_term_diff_neqNT_1D_SL_cyl_Jac(r_c, vol_l, vol_c, vol_r, prop_left, prop_cell, prop_right, & 
    ...
    PRINT*,'In "source_term_diff_neqNT_1D_SL_cyl_Jac.F90",implementation to be finshed!'
    STOP

  END SUBROUTINE source_term_diff_neqNT_1D_SL_cyl_Jac
!------------------------------------------------------------------------------!

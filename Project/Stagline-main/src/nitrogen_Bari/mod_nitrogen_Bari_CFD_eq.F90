!------------------------------------------------------------------------------!
! This module provides subroutines for equilibrium properties of the Bari database for the N-N2 ystem 
  MODULE mod_nitrogen_Bari_CFD_eq

    USE mod_nitrogen_Bari_initialize_CFD,     ONLY: mm_N, mm_N2
    ...
    CONTAINS 
      ...
      SUBROUTINE eq_composition (p, T, xn, xn2)
        ...
        USE mod_nitrogen_Bari_initialize_CFD,    ONLY: gn, ukb, Edis
      ...
      SUBROUTINE eq_composition_vib (p, T, rhoi, x_N)
        ...
        USE mod_nitrogen_Bari_initialize_CFD,    ONLY: nb_bins, ukb, una, urg, EkJ
      ...
      SUBROUTINE tr_part_function (T, mm, Qtr)
        ...
        USE mod_nitrogen_Bari_initialize_CFD,     ONLY: fac_Q
      ...
      SUBROUTINE int_part_function (T, Qint)
        ...
        USE mod_nitrogen_Bari_initialize_CFD,     ONLY: nb_bins, ov_sigma, theta_rot, ukb, EkJ
      ...
      SUBROUTINE energy (T, e)
        ...
        USE mod_nitrogen_Bari_initialize_CFD,    ONLY: nb_bins, cv_tr_N, cv_tr_N2, R_N2, hf_N, & 
                                                         &  ukb, una, mm_N2, EkJ
      ...
      SUBROUTINE enthalpy (T, h)
        ...
        USE mod_nitrogen_Bari_initialize_CFD,    ONLY: R_N, R_N2
      ...
      SUBROUTINE entropy (p, T, yi, xi, smix, s) 
        ...
        USE mod_nitrogen_Bari_initialize_CFD,    ONLY: nb_ns, gN, ukb, hf_N, mm_N, mm_N2, R_N, R_N2 
      ...
      SUBROUTINE get_species_energy (T, e)
        ...
        USE mod_nitrogen_Bari_initialize_CFD,     ONLY: nb_bins, hf_N, cv_tr_N, cv_tr_N2, R_N2, ek
      ...
      SUBROUTINE post_shock_eq (p1, u1, T1, p2, u2, T2, yi, rhoi, xN)
        ...
        USE mod_Nitrogen_Bari_initialize_CFD,           ONLY: nb_ns, urg, solver
        ...
        WRITE(*,5)solver(1:length),':: Nitrogen Bari -> equilibrium post-shock conditions'
        PRINT*
...
15    FORMAT(A,E14.6,A)
  ...
  END MODULE mod_nitrogen_Bari_CFD_eq
!------------------------------------------------------------------------------!

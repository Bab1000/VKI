!------------------------------------------------------------------------------!
!> This subroutine applies a null 1D polynomial reconstruction for stagnation line 1D calorically perfect gas flows.
!! It is used for first order space accurate solutions.
  SUBROUTINE null_poly_rec_1D_SL (vol_ll, vol_l, vol_r, vol_rr, ull, ul, ur, urr, prop_ll, prop_l, prop_r, prop_rr, & 
  ...
  END SUBROUTINE null_poly_rec_1D_SL
!------------------------------------------------------------------------------!

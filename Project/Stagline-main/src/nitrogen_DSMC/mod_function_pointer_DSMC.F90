!------------------------------------------------------------------------------!
! This module provides pointer definition for the Nitrogen DSMC library.
  MODULE mod_function_pointer_DSMC
    ...
    PROCEDURE(get_temperatures), POINTER, SAVE :: get_temp_DSMC
    PROCEDURE(get_temperatures) :: compute_T, compute_T_Tv, compute_T_Tr_Tv

    PROCEDURE(get_frozen_cv), POINTER, SAVE :: get_species_cv_DSMC
    PROCEDURE(get_frozen_cv) :: compute_frozen_cv_T, compute_frozen_cv_T_Tv, compute_frozen_cv_T_Tr_Tv   

    PROCEDURE(get_frozen_energy_cv), POINTER, SAVE :: get_species_energy_cv_DSMC
    PROCEDURE(get_frozen_energy_cv) :: compute_frozen_energy_cv_T, compute_frozen_energy_cv_T_Tv,  & 
                                     & compute_frozen_energy_cv_T_Tr, compute_frozen_energy_cv_T_Tr_Tv

  END MODULE mod_function_pointer_DSMC
!-------------------------------------------------------------------------------!

!------------------------------------------------------------------------------!
!> This subroutine sets to zero the diffusive source term and the related Jacobians for 1D inviscid stagnation line flows.
  SUBROUTINE null_diff_source_term_SL_Jac(r_c, vol_l, vol_c, vol_r, prop_left, prop_cell, prop_right, & 
  ...
  END SUBROUTINE null_diff_source_term_SL_Jac
!------------------------------------------------------------------------------!

!------------------------------------------------------------------------------!
!> This subroutine computes the diffusive source term for 1D stagnation line calorically perfect gas flows (sphere case).
  SUBROUTINE source_term_diff_1D_SL_sph (r_c, vol_l, vol_c, vol_r, prop_left, prop_cell, prop_right, & 
  ...
  END SUBROUTINE source_term_diff_1D_SL_sph
!------------------------------------------------------------------------------!

...
!! for 1D nonequilibrium gas flows. In this case the gas flow is described by means of a single temperature.  
  SUBROUTINE Steger_Warming_neq1T_1D (nx, left_data, right_data, u_left, u_right, f) 

    USE mod_general_data,             ONLY: nb_ns, pos_u_cell, pos_rho_cell, pos_c_cell, pos_h0_cell, pos_gamma_cell,  & 
                                          & pos_rhou, pos_rhoE, yi
  ...
  END SUBROUTINE Steger_Warming_neq1T_1D  
!------------------------------------------------------------------------------!

!------------------------------------------------------------------------------!
!> This subroutine computes the convective flux by means of the flux-vector-splitting proposed 
!! by van Leer for a 1D nonequilibrium flow.
  SUBROUTINE van_leer_neq_1D (nx, left_data, right_data, u_left, u_right, f)
 
    USE mod_general_data,             ONLY: nb_eq, nb_ns, nb_temp, nb_int_temp, nb_te, pos_u_cell, pos_h0_cell, &
                                          & pos_pres_cell, pos_gamma_cell, pos_c_cell, pos_rho_cell,            & 
                                          & pos_rhou, pos_rhoE, pos_T_cell
    ...
    REAL(KIND=8) :: cl, cr, gl, gr, h0l, h0r, Mnl, Mnr, pr, pl, rhol, rhor, ul, ur, unl, unr
  ...
  END SUBROUTINE van_Leer_neq_1D
!------------------------------------------------------------------------------!

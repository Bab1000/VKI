...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        USE mod_general_data,          ONLY: nb_eq, nb_ns, volumes, nb_dim, nb_temp
        ...
        REAL(KIND=8), DIMENSION(nb_ns,2*j_max) :: smb 
        REAL(KIND=8), DIMENSION(nb_ns) :: rhoi_wall_old
        ...
        DO j = 1,4
           ...
           DO i = 1,nb_ns
              ...
              smb(i,j) = conv(i) + Ji(i) - (omega_wall(i) +  pyro(i))
           ENDDO
           ...
           IF (check.eq.0) THEN
              ...
              ! New wall species densities evaluation (Newton)
              DO i = 1,nb_ns
                 rhoi_wall(i) = rhoi_wall_old(i) - smb(i,j-1) / (smb(i,j) - smb(i,j-1)) * (rhoi_wall(i) - rhoi_wall_old(i))
              ENDDO
           ...
           DO i = 1,nb_ns
              rhoi_wall(i) = rhoi_wall(i) * (1.d0+eps*1.d8)
           ENDDO

!------------------------------------------------------------------------------!
!> This subroutine computes the left and right state Jacobian of the diffusive flux for 
!! 1D stagnation line flows by means of numerical differentiation
  SUBROUTINE diff_flux_num_Jac_1D_SL(r_l, r_r, vol_l, vol_r, left_data, right_data, u_left, u_right, fd, jfdl, jfdr)

    USE mod_general_data,              ONLY: nb_eq, nb_prop, eta
    USE mod_function_pointer,          ONLY: diff_flux_1D_SL, get_phys_from_cons 
    ...
    ! Diffusive flux
    CALL diff_flux_1D_SL(r_l, r_r, vol_l, vol_r, left_data, right_data, u_left, u_right, fd)
    ...
    DO j = 1,nb_eq 
       ...
       CALL diff_flux_1D_SL(r_l, r_r, vol_l, vol_r, left_data_pert, right_data, u_left_pert, u_right, fl_pert)
       CALL diff_flux_1D_SL(r_l, r_r, vol_l, vol_r, left_data, right_data_pert, u_left, u_right_pert, fr_pert)
  ...
  END SUBROUTINE diff_flux_num_Jac_1D_SL
!------------------------------------------------------------------------------!

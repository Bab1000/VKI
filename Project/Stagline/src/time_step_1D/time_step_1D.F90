...
!! for time-accurate solutions.
   SUBROUTINE time_step_time_acc_1D (vol, phys_prop, dt)
   ...
   END SUBROUTINE time_step_time_acc_1D
!------------------------------------------------------------------------------!
!> This subroutine computes the time-step for 1D inviscid flows.
  SUBROUTINE inv_time_step_1D (vol, phys_prop, dt)
  ...
  END SUBROUTINE inv_time_step_1D 
!------------------------------------------------------------------------------!
!> This subroutine computes the time-step for 1D viscous flows.
  SUBROUTINE visc_time_step_1D (vol, phys_prop, dt)

    USE mod_numerics_data,         ONLY: vnn
    USE mod_function_pointer,      ONLY: get_visc_spectral_radius_1D
    ...
    CALL get_visc_spectral_radius_1D (phys_prop, sp)

    ! Time-step
    dt = 0.5d0*vnn*vol**2/sp

  END SUBROUTINE visc_time_step_1D
!------------------------------------------------------------------------------!
!> This subroutine computes the time-step for 1D viscous flows by combining the 
!! contributions of the inviscid and viscous spectral radii. 
  SUBROUTINE inv_visc_time_step_1D (vol, phys_prop, dt)
    ...
    CALL get_visc_spectral_radius_1D (phys_prop, sp_visc)

    ! Time-step    
    dt = cfl*vol/(sp_inv + sp_visc/vol) 

  END SUBROUTINE inv_visc_time_step_1D 
!------------------------------------------------------------------------------!

!------------------------------------------------------------------------------!
! This module provides subroutines/function for the thermodynamic properties of Bari database for the N-N2 system.
  MODULE mod_nitrogen_Bari_CFD_prop
    ...
    CONTAINS 
      ...
      SUBROUTINE Q_rot (T, Q)
        ...
        USE mod_nitrogen_Bari_initialize_CFD,     ONLY: theta_rot, ov_sigma
      ...
      SUBROUTINE get_species_cv (T, cv)
        ...
        USE mod_nitrogen_Bari_initialize_CFD,     ONLY: nb_bins, cv_tr_N, cv_tr_N2, R_N2
      ...
      SUBROUTINE get_species_cp (T, cp)
        ...
        USE mod_nitrogen_Bari_initialize_CFD,     ONLY: nb_bins, R_N, R_N2
      ...
      SUBROUTINE post_shock_neq (p1, u1, T1, p2, u2, T2, yi, x_N)
        ...
        USE mod_nitrogen_Bari_initialize_CFD,      ONLY: nb_ns, mm_N, mm_N2, urg, cv_tr_N, cv_tr_N2
      ...
      SUBROUTINE compute_Tint (ni, Tint)
        ...
        USE mod_nitrogen_Bari_initialize_CFD,     ONLY: nb_bins, EkJ, ukb
  ...
  END MODULE mod_nitrogen_Bari_CFD_prop
!------------------------------------------------------------------------------!

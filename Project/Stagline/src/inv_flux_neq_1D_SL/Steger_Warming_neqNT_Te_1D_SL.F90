...
!! plus a separated temperature Te for free electrons.
  SUBROUTINE Steger_Warming_neqNT_Te_1D_SL (nx, vol_l, vol_r, left_data, right_data, u_left, u_right, f) 
    ...
    PRINT*
    WRITE(*,'(A)')'In "Steger_Warming_neqNT_Te_1D_SL.F90", not implemented yet...'
    PRINT*
    STOP

  END SUBROUTINE Steger_Warming_neqNT_Te_1D_SL
!------------------------------------------------------------------------------!

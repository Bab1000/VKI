...
!! (sphere case)
  SUBROUTINE ns_flux_1D_SL_sph (r_l, r_r, vol_l, vol_r, left_data, right_data, u_left, u_right, fd)
  ...
  END SUBROUTINE ns_flux_1D_SL_sph
!------------------------------------------------------------------------------!
!------------------------------------------------------------------------------!
!> This subroutine computes the diffusive flux when solving the 1D stagnation line equations for a calorically perfect gas.
!! and accounting for the mesh metrics (sphere case) (A. Turchi)
  SUBROUTINE ns_flux_1D_SL_sph_metr (r_l, r_r, vol_l, vol_r, left_data, right_data, u_left, u_right, fd)
  ...
  END SUBROUTINE ns_flux_1D_SL_sph_metr
!------------------------------------------------------------------------------!

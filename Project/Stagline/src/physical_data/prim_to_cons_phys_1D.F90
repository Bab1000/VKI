...
!! 1D calorically perfect gas flows when solving the Euler equations
  SUBROUTINE prim_to_cons_phys_1D_Eu (prim, cons, phys_prop) 

    USE mod_general_data,             ONLY: pos_u_cell, pos_h0_cell, pos_pres_cell, pos_c_cell, & 
  ...
  END SUBROUTINE prim_to_cons_phys_1D_Eu
!------------------------------------------------------------------------------!
!> This subroutine computes the conservative and physical variables from the primitive variables for 
!! 1D calorically perfect gas flows when solving the Navier-Stokes equations
  SUBROUTINE prim_to_cons_phys_1D_Ns (prim, cons, phys_prop) 

    USE mod_general_data,             ONLY: pos_u_cell, pos_h0_cell, pos_pres_cell, pos_c_cell,  &   
                                          & pos_ek_cell, pos_rho_cell, pos_T_cell, pos_mu_cell,  & 
                                          & pos_kappa_cell, pos_lambda_cell, gamma, R_gas
  ...
  END SUBROUTINE prim_to_cons_phys_1D_Ns
!------------------------------------------------------------------------------!

!------------------------------------------------------------------------------!
!> Thus subroutine provides the inviscid flux Jacobian spectral radius for the 1D stagnation line Euler equations.
  SUBROUTINE inv_spectral_radius_1D_SL (phys_prop, sp)
  ...
  END SUBROUTINE inv_spectral_radius_1D_SL
!------------------------------------------------------------------------------!
!> This subroutine sets the diffusive flux Jacobian spectral radius to zero when
!! solving the 1D stagnation line Euler equations
  SUBROUTINE null_visc_spectral_radius_1D_SL (phys_prop, sp)
  ...
  END SUBROUTINE null_visc_spectral_radius_1D_SL
!------------------------------------------------------------------------------!
!> This subroutine provides the diffusive flux Jacobian spectral radius for the 1D stagnation line Navier-Stokes equations
!! for a calorically perfect gas.
  SUBROUTINE visc_spectral_radius_1D_SL (phys_prop, sp)
    ...
    ! Viscous eigenvalues associated to the radial momentum equation and the 
    ! and global energy equations
    l1 = coeff*mu/rho
  ...
  END SUBROUTINE visc_spectral_radius_1D_SL
!------------------------------------------------------------------------------!
!> This subroutine provides the diffusive flux Jacobian spectral radius for the 1D stagnation line Navier-Stokes equations
!! for a nonequilibrium flow.
  SUBROUTINE visc_spectral_radius_neq_1D_SL (phys_prop, sp)
    ...
    ! Viscous eigenvalues associated to to the radial momentum equation and the 
    ! and global energy equations
    l1 = coeff*mu/rho
    l2 = lambda/beta
  ...
  END SUBROUTINE visc_spectral_radius_neq_1D_SL
!------------------------------------------------------------------------------!

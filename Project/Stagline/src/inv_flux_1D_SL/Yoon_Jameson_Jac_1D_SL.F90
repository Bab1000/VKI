...
!! according to the approximation proposed by Yoon and Jameson.
  SUBROUTINE Yoon_Jameson_Jac_1D_SL (nx, vol_l, vol_r, left_data, right_data, u_left, u_right, jfl, jfr)
    ...
    ! Explicit interface for external subroutine inviscid_flux_Jac_1D_SL
    INTERFACE 
    ...
    IF (Mnl.GE.1.d0) THEN
       ...
       ! Supersonic flow
       CALL inviscid_flux_Jac_1D_SL (nx, left_data, jfl) 
    ...
    IF (Mnr.LE.-1.d0) THEN
       ...
       ! Supersonic flow
       CALL inviscid_flux_Jac_1D_SL (nx, right_data, jfr) 
  ...
  END SUBROUTINE Yoon_Jameson_Jac_1D_SL
!------------------------------------------------------------------------------!

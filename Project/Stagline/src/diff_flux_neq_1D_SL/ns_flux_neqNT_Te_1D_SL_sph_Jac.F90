...
!! for nonequilibrium flows (sphere case - N temperatures and one for free electrons Te).
  SUBROUTINE ns_flux_neqNT_Te_1D_SL_sph_Jac (r_l, r_r, vol_l, vol_r, left_data, right_data, u_left, u_right, fd, & 
                                           & jfdl, jfdr)
    ...
    PRINT*,'In "ns_flux_neqNT_Te_1D_SL_sphl_Jac.F90", implementation to be finshed'
    STOP

  END SUBROUTINE ns_flux_neqNT_Te_1D_SL_sph_Jac
!------------------------------------------------------------------------------!

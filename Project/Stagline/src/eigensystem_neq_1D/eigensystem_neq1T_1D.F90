...
!! In this case the flow is characterized by one single temperature T.
  SUBROUTINE eigensystem_neq1T_1D (nx, cons, phys_data, eig, right_eig, left_eig) 

    USE mod_general_data,         ONLY: nb_ns, pos_u_cell, pos_c_cell, pos_ek_cell, pos_alpha_cell, & 
                                      & pos_h0_cell, pos_ei_cell, pos_rho_cell, pos_T_cell,         & 
                                      & pos_rhou, pos_rhoE, Ri, epsi, sigmai, ei, yi

...
!! (cylinder case - 1 temperature).
  SUBROUTINE source_term_diff_neq1T_1D_SL_cyl (r_c, vol_l, vol_c, vol_r, prop_left, prop_cell, prop_right, & 
    ...
    ! Temperature, pressure, velocity components of central state
  ...
  END SUBROUTINE source_term_diff_neq1T_1D_SL_cyl
!------------------------------------------------------------------------------!

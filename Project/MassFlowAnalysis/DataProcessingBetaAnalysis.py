...
for press in targ_p:
    for Pow in targ_P:
        ...
        comparison_plot_path = os.path.join("/home/jpe/VKI/Project/MassFlowAnalysis/Results_BetaMixtComp", f"BetaComparison_Pc={press}_Pw={Pow}.pdf")

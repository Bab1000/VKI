...
model_path = "/home/jpe/VKI/Project/MachineLearning/GeneticAlgorithm/KRGModel/SM_Gamma_Log"
...
pressure, heat_flux, pitot, temperature = FullDataLoading(CSV_path)
...
X_S, X_U, X_V, Q_pred, Error = GA_model(sm_q,pitot,pressure,temperature,Func,X_Bounds,heat_flux,n_p,N_ITER,n_G,sigma_I_r,mu_I,mu_F,p_M,n_E)
...
try:
    ...
    path_results = "GA_Full_results_exp_campaign.csv"

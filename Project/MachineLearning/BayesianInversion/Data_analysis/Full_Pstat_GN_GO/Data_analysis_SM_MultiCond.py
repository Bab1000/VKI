...
global_output_path = "/home/jpe/VKI/Project/MachineLearning/BayesianInversion/Data_analysis/Full_Pstat_GN_GO"
...
for targ_p in target_pressure:
    ...
    # === Getting the samples ===
    trace_path = f"/home/jpe/VKI/Project/MachineLearning/BayesianInversion/Simulations/Full_Pstat_GN_GO/UniformG_MultiCond_Pstat={targ_p/100}/Posteriors/Thinned_trace.nc"  
    ...
    #plot_joint_GN_GO(samples,targ_p,global_output_path)
#
    #MAP_plots(
    #    sm_model=sm_q,
    #    samples=samples,
    ...
    #GN_GO_plotting(samples,targ_p,global_output_path)
    
    #plot_correlation(idata, targ_p, kind='scatter', show_plots=False, save_dir= global_output_path + "/Correlation")

    #sensitivity_gamma(sm_q, gamma_range=np.linspace(-4, 0, 50),
            #Pdyn_list=Pdyn_test, MF_list=MF_test,T_list=T_test, target_p=targ_p, output_path = global_output_path)

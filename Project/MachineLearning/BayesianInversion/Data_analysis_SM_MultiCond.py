...
for targ_p in target_pressure:
    ...
    for targ_mf in target_massflow:
        ...
        # === Getting the samples ===
        trace_path = f"/home/jpe/VKI/Project/MachineLearning/BayesianInversion/New_Simulations/Mass_Flow_based_testing/UniformG_MultiCond_Pstat={targ_p/100}/MassFlow={targ_mf}/Posteriors/Thinned_trace.nc"  
        ...
        plot_joint_GN_GO(samples,targ_p,targ_mf)
        ...
        Mean_plots(
            ...
            trace_path=f"/home/jpe/VKI/Project/MachineLearning/BayesianInversion/New_Simulations/Mass_Flow_based_testing/UniformG_MultiCond_Pstat={targ_p/100}/MassFlow={targ_mf}/Posteriors/Thinned_trace.nc",
            output_path=f"/home/jpe/VKI/Project/MachineLearning/BayesianInversion/Data_analysis/New_simulations/Mass_Flow_based_testing/Mean_HF_values/FullCond_UniformG_Pred_vs_Exp_Pstat={targ_p/100}_mf={targ_mf:.0f}.jpeg"
        )
        ...
        MAP_plots(
            ...
            output_path=f"/home/jpe/VKI/Project/MachineLearning/BayesianInversion/Data_analysis/New_simulations/Mass_Flow_based_testing/MAP_HF_values/FullCond_MAP_Pstat={targ_p/100}_mf={targ_mf:.0f}.jpeg",

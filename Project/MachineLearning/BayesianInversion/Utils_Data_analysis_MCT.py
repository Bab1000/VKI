...
def MAP_plots(sm_model,samples,targ_p,targ_mf,Pdyn_test,T_test,T_exp_list,HF_exp_list,HF_exp_err_list,output_path,std_pred=None,method="global",n_local_samples=5000,annotate=True):
    """
    ...
    for i in range(len(T_exp_list)):
        try:
            ...
            predictions = np.array(predictions)
            map_hf = get_map(predictions,T_exp_list[i],targ_p,targ_mf,HF_exp_list[i])
...
def get_map(predictions,T,targ_p,targ_mf,HF_exp_val):
    """
    ...
    output_path=f"/home/jpe/VKI/Project/MachineLearning/BayesianInversion/Data_analysis/New_simulations/Mass_Flow_based_testing/HF_distributions/HF_dist_Pstat={targ_p/100}_mf={targ_mf:.0f}_T={T:.0f}.jpeg"
...
def plot_joint_GN_GO(samples, targ_p, targ_mf):
    """
    ...
    output_path=f"/home/jpe/VKI/Project/MachineLearning/BayesianInversion/Data_analysis/New_simulations/Mass_Flow_based_testing/GN_GO_distributions/GN_GO_JointDist={targ_p/100}_mf={targ_mf:.0f}.jpeg"

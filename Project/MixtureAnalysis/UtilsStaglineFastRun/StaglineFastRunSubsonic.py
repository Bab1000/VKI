...
def StaglineFastRunSubsonic(Tin,pc,mixture,pdyn,uin,vin,R,n_species,cfl_val,Twall,cfl_inter,cfl_adaptive,Log_CFL,residual,restart,stagline_simulations_path,input_template_path,CFL_range,Iter,air_5_restart):
    # -----------------------------------------------
    ...
    # Stagline simulation
    # -------------------
    RunStagline(sim_folder_path,sim_name,CFL_range,Iter,cfl_inter)
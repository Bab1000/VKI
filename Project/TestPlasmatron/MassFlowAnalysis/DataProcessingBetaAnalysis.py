...
for press in targ_p:
    for Pow in targ_P:
        ...
        for label, g_path in glob_path.items():
            ...
            plot_path = os.path.join(g_path, "Results", f"Beta_Pc={press}_Pw={Pow}.jpeg")
        ...
        comparison_plot_path = os.path.join("/home/jpe/VKI/Project/MassFlowAnalysis/Results_BetaMixtComp", f"BetaComparison_Pc={press}_Pw={Pow}.jpeg")

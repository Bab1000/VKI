...
for press in targ_p:
    ...
    # Save the figure
    comparison_plot_path = os.path.join("/home/jpe/VKI/Project/MassFlowAnalysis/Results_Rebuilding", f"HFComparison_Pc={press}.pdf")
    ...
    plt.savefig(f"/home/jpe/VKI/Project/MassFlowAnalysis/Results_Rebuilding/h_edgeComparison_Pc={press}.pdf", format='pdf', dpi=600, bbox_inches='tight', transparent=True)
    ...
    plt.savefig(f"/home/jpe/VKI/Project/MassFlowAnalysis/Results_Rebuilding/betaComparison_Pc={press}.pdf", format='pdf', dpi=600, bbox_inches='tight', transparent=True)
    ...
    plt.savefig(f"/home/jpe/VKI/Project/MassFlowAnalysis/Results_Rebuilding/p0Comparison_Pc={press}.pdf", format='pdf', dpi=600, bbox_inches='tight', transparent=True)

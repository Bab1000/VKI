# -*- coding: utf-8 -*-
"""
Created on Sun Jan 23 15:03:41 2024
...
def Random_S(func,X0,X_Bounds,R,n_iter):
...
X_k,Cost_k =Random_S(rosenbrock,X0,X_Bounds,R=0.2,n_iter=100)

# Here's the animation for this search:

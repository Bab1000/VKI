# -*- coding: utf-8 -*-
"""
Created on Sun Jan 23 15:03:41 2023
...
# The function below is identical, but also plots the intermediate steps/

from GA_Functions import Anim_COMP


# Run the Animation
X_S, X_U, X_V=Anim_COMP(Func=rosenbrock,X_Bounds=X_Bounds,
                        n_p=200,N_ITER=50,n_G=0.5,
                        sigma_I_r=6,mu_I=0.02,mu_F=0.0001,p_M=0.5,n_E=0.05, 

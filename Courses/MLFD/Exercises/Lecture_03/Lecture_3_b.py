...
from Lecture_3_Functions import num_response, theor_response, Error, Grad_Error
...
plt.plot(ts,np.heaviside(ts,1),color='k',label='Step')
...
plt.ylabel('Execution time [s]')
plt.xticks([1,2,3,4], ['CG', r'\noindent CG\\(SciPy)', r'BFGS', r'\noindent BFGS\\(SciPy)'])
plt.tight_layout()
